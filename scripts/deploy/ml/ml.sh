...
nova boot --image $1 --nic net-id=$2 --flavor $3 --key-name=$4 spark_master
sleep 10

nova boot --image $1 --nic net-id=$2 --flavor $3 --key-name=$4 spark_slaves1
sleep 10

nova boot --image $1 --nic net-id=$2 --flavor $3 --key-name=$4 spark_slaves2
sleep 10
